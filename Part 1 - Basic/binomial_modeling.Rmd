...
This webinar series is divided into three parts.

- Part 1 (November 3) Bayesian Fundamentals

- Part 2 (November 10) Bayesian Regression

- Part 3 (November 17) Multilevel Modeling

## Structure

- Each part will consist of two 50-minute presentations, followed by a 10 minute time for questions.
...
- Recently we coauthored the text _Probability and Bayesian Modeling_.
...
- Can ask questions by use of the chat window.
