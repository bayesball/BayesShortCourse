...
$$y_{ij} \sim N(\beta_{0j} + \beta_{1j} EFFECT_{ij}, \sigma)$$

- Let $\beta_i = (\beta_{0j}, \beta_{1j})$ denote vector of regression coefficients for the $i$th player
